...
void SdfRenderer::commit()
{
    ...
    ispc::SdfRenderer_set(getIE(), (ispc::vec3f&)_bgColor, _shadows,
                          _softShadows, _spp, _lightPtr, _lightArray.size(),
                          _samplesPerRay, _timestamp, _nbIterations);
}

SdfRenderer::SdfRenderer()
{
    ispcEquivalent = ispc::SdfRenderer_create(this);
}

OSP_REGISTER_RENDERER(SdfRenderer, sdf);
} // namespace sdf
